					...
					<div class="col-md-12">
						<div class="wrapper px-md-4">
							<div class="row mb-5">
				        		...
				        		<div class="text">
					            <p><span>Address:</span> 182 Nguyen Van Linh Street, HCM City</p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Phone:</span> <a href="tel://1234567920">+84 358 178 201</a></p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Email:</span> <a href="mailto:info@yoursite.com">tinle@gmail.com</a></p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Website</span> <a href="#">flowerstore.com</a></p>
					          </div>
				          </div>
								</div>
							</div>

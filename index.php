...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row">
            ...
            $products = getRow("SELECT p.prd_ID, p.prd_name, p.prd_img, p.prd_price, p.cate_ID, c.cate_name 
            FROM products p JOIN categories c ON p.cate_ID = c.cate_ID
            WHERE (p.prd_status = 1 OR p.prd_status = 3)
            ORDER BY p.cate_ID,p.prd_ID;");
                            ...
                            <div class="img d-flex align-items-center justify-content-center" style="background-image: url(<?php echo $product['prd_img']; ?>);">
                                <div class="desc">
                                    <p class="meta-prod d-flex">
                                        <a href="product-detail.php?prd_ID=<?php echo $product['prd_ID']; ?>" class="d-flex align-items-center justify-content-center">
